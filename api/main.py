...
from api.routers import auth, blast, cost, calibration, datasets, design, drift, economics, learning, optimization, outcomes, recommendation, references, registry, scenarios, spatial, workspace
...
app.include_router(calibration.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(outcomes.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(scenarios.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(optimization.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(recommendation.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(learning.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(registry.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(drift.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
app.include_router(spatial.router, prefix=API_PREFIX, dependencies=_internal_dependencies)
