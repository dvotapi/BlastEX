...
# Общие поля цен: цена из журнала переписывает только эти поля в черновике
# (§4.1). Имя пользователя и код материала не сравниваются: первое может быть
# переименовано, второе переписывается при применении связей материала.
